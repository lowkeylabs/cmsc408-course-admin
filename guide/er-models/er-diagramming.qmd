...
```{=html}
 <script type="module">
        ...
        function updateDiagram() {
            const code = document.getElementById('input_01').value;
            const diagramContainer = document.getElementById('diagram_01');

            // Clear the diagram container
            diagramContainer.innerHTML = '';

            // Create a new div for the Mermaid code
            ...
            // Remove the "data-processed" attribute if it exists
            newDiv.removeAttribute("data-processed");

            // Run Mermaid to process the new content
            mermaid.run({ nodes: [newDiv] });
        }
        ...
        window.addEventListener('DOMContentLoaded', () => {
            ...
            document.getElementById('input_01').addEventListener('input', updateDiagram);
...
```{=html}
<textarea id="input_01" rows="25" cols="30">
erDiagram
    CUSTOMER {
        int customer_id PK
        string name

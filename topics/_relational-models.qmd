...
Codd, E. F. (1970). *A relational model of data for large shared data banks*. *Communications of the ACM, 13*(6), 377–387. [https://doi.org/10.1145/362384.362685](https://doi.org/10.1145/362384.362685)

:::: {.columns}
::: {.column width=47%}

::: {style="font-size:10pt"}
1. **Data is Represented as Relations (Tables)**  
   - Codd introduced the concept of **relations**, which are mathematically defined as sets of tuples (rows) with attributes (columns). This formal structure provides a consistent and logical way to store and manipulate data.

2. **Data Independence and Normalization**  
   - The relational model promotes **data independence**, meaning applications don’t need to worry about the underlying data storage structure. He also introduced the idea of **normalization** to reduce redundancy and improve data integrity.

3. **Use of a High-Level Language (Relational Algebra)**  
   - Codd proposed using **relational algebra** and **relational calculus** as a mathematical foundation for querying data, emphasizing that users should interact with the database using **declarative** queries rather than navigating storage structures directly.

4. **Keys and Integrity Constraints**  
   - The paper introduced the importance of **primary keys** to uniquely identify tuples and defined integrity constraints (e.g., uniqueness and referential integrity) to ensure consistency and correctness of the data.

This work eventually led to the development of SQL and the modern relational database systems we use today.
:::
...
* course( <u>course_id</u>, title, credit_hours)
* student_course( <u>id</u>, student_id[FK], course_id[FK])
...
<table border="0" cellborder="1" cellspacing="0">
    <tr><td colspan="3" align="center"><b>Courses</b></td></tr>
    <tr><td><b>id</b></td><td><b>name</b></td><td><b>hours</b></td></tr>
    <tr><td port="">NULL</td><td>NULL</td><td>NULL</td></tr>
    <tr><td port="c1">1</td><td>CMSC391</td><td>3</td></tr>
    <tr><td port="">NULL</td><td>NULL</td><td>NULL</td></tr>
    <tr><td port="c2">2</td><td>CMSC475</td><td>3</td></tr>
    <tr><td port="c3">3</td><td>CMSC508</td><td>3</td></tr>
...
## Relational Model - One-to-Many example
...
digraph RelationalDataModel {
    ...
    Authors [label=<
        <table border="0" cellborder="1" cellspacing="0">
            <tr><td><b>id (PK)</b></td><td><b>name</b></td><td><b>birthdate</b></td></tr>
            <tr><td port="f1">1</td><td>DiShawn</td><td>1980-01-01</td></tr>
            <tr><td port="f3b">3</td><td>Halle</td><td>1975-05-14</td></tr>
            <tr><td port="f2">2</td><td>Christopher</td><td>1975-05-14</td></tr>
            <tr><td port="f2a">2</td><td>Christopher</td><td>1975-05-14</td></tr>
            <tr><td port="f3">3</td><td>Halle</td><td>1975-05-14</td></tr>
            <tr><td port="f4">4</td><td>Fayad</td><td>1990-02-20</td></tr>
            <tr><td port="f1a">1</td><td>DiShawn</td><td>1980-01-01</td></tr>
            <tr><td port="f3a">3</td><td>Halle</td><td>1975-05-14</td></tr>
            <tr><td port="f5">5</td><td>Hermes</td><td>1960-12-29</td></tr>
        </table>
    >];
    ...
    Books:f1 -> Authors:f1 [label="" dir=none constraint=false];
    Books:f3 -> Authors:f2 [dir=none constraint=false];
    Books:f4 -> Authors:f2a [dir=none constraint=false];
    Books:f6 -> Authors:f1a [dir=none constraint=false];
    Books:f8 -> Authors:f5 [dir=none constraint=false];

    Books:f2 -> Authors:f3b [dir=none constraint=false];
    Books:f5 -> Authors:f3 [dir=none constraint=false];
    Books:f7 -> Authors:f3a [dir=none constraint=false];
}
...
## Relational Model - Many-to-Many example

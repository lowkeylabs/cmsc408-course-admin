...
* [Edgar "Ted" Codd](https://en.wikipedia.org/wiki/Edgar_F._Codd) defines the [Relational data model](https://dl.acm.org/doi/pdf/10.1145/362384.362685)
* [High-performance (for the era) transaction processing](https://en.wikipedia.org/wiki/Transaction_processing)
* First [UPC codes](https://www.smithsonianmag.com/innovation/history-bar-code-180956704/) scanned in 1974 at a supermarket.
:::
::: {.column width="40%"}
...
* [QR Code](https://en.wikipedia.org/wiki/QR_code) was invented in 1994 to track car parts.
:::
::: {.column}

...
.no-stretch {
//  max-width: 600px;   /* Prevents the figure from expanding beyond 600px */
//  width: 100%;
...
# Get the current axes and set the aspect ratio
#plt.gca().set_aspect('equal')  # 'equal' ensures that one unit on the x-axis is the same length as one unit on the y-axis

...
date: 10/23/2023
lecture-id: 14
title: SQL Create/Insert/Delete/Update
---
...
- Homework 6 - due next Sunday, 10/29
- Open computer session - Noon-4pm tomorrow, 10/24 in ERB
- Autograder not open yet.  Will show 0/10 until open it.
- Quiz - SQL - next Wednesday, Nov. 1st.  Same routine.  Practice quiz soon.
- Changes to [Course Schedule.](https://virginiacommonwealth.instructure.com/courses/85746/pages/intro-course-schedule)
...
one big push.
* Create a file (e.g., HW7-DDL.sql) and add
all the commands. 
...
* API is constructed separate from UI
